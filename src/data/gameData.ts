...
export const zones: ZoneDefinition[] = [
  ...
  { id: 'sunpetal-meadow', order: 2.2, title: '해바라기 초원', subtitle: '밝은 초원에 임프와 늑대가 섞여드는 완충 전선', description: '초반 자동사냥이 한 지점에 갇히지 않도록 긴 산책 동선과 몬스터 포켓을 가진 사냥터입니다.', recommendedLevel: 2, monsterIds: ['slime', 'wolf', 'shadowImp'], entry: { x: 6.6, y: 18.2 }, unlockLevel: 2, badge: '02A' },
  { id: 'misty-riverbank', order: 3.2, title: '안개 낀 강가', subtitle: '수로를 따라 고블린과 망령이 번갈아 출몰하는 길', description: '좁은 강변 길을 따라 여러 구역을 이동하며 사냥하는 초중반 필드입니다.', recommendedLevel: 4, monsterIds: ['wolf', 'shadowImp', 'goblin', 'wraith'], entry: { x: 8.0, y: 22.8 }, unlockLevel: 4, badge: '03A' },
  { id: 'old-watchyard', order: 4.2, title: '무너진 감시마당', subtitle: '고블린 보급대와 골렘 잔해가 모이는 폐허', description: '폐허를 크게 돌아다니며 전투하는 구조로, 몬스터 수와 난이도가 기존보다 높습니다.', recommendedLevel: 6, monsterIds: ['goblin', 'mossGolem', 'wraith'], entry: { x: 10.6, y: 20.6 }, unlockLevel: 6, badge: '04A' },
  { id: 'echo-lantern-woods', order: 5.2, title: '메아리 등불숲', subtitle: '하피와 망령의 소리가 겹치는 야간 숲', description: '원거리 압박과 패턴을 연습하는 숲 사냥터입니다. 자동스킬과 물약 설정을 확인하세요.', recommendedLevel: 8, monsterIds: ['stormHarpy', 'wraith', 'wolf', 'shadowImp'], entry: { x: 11.8, y: 18.6 }, unlockLevel: 8, badge: '05A' },
  { id: 'fallen-aqueduct', order: 6.2, title: '무너진 수도교', subtitle: '수정 곰과 묘지 기사가 길목을 지키는 중급 관문', description: '한 구역에 머무르지 않고 포켓을 이동해야 안정적으로 사냥되는 중급 사냥터입니다.', recommendedLevel: 11, monsterIds: ['crystalBear', 'graveKnight', 'mossGolem', 'wraith'], entry: { x: 13.4, y: 23.4 }, unlockLevel: 11, badge: '06A' },
