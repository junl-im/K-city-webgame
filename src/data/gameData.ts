...
export const items: ItemDefinition[] = [
  ...
  { id: 'hp-potion-mid', name: '중급 생명 물약', type: 'consumable', rarity: 'R', effectText: '즉시 HP 55% 회복.', bonus: {}, consume: { hpPercent: 0.55 } },
  { id: 'mp-potion-mid', name: '중급 마나 물약', type: 'consumable', rarity: 'R', effectText: '즉시 MP 60% 회복.', bonus: {}, consume: { mpPercent: 0.60 } },
