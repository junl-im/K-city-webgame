...
export function renderSystemDoctor087(params: {
  ...
  return `
    <section class="system-doctor-085 system-doctor-086 system-doctor-087 ${escapeAttr087(params.mode)}" aria-label="0.87 시스템 닥터">
      <div class="system-doctor-head-085">
        <span class="panel-kicker">SYSTEM DOCTOR · 0.87</span>
        <h3>문제점·연결성·성능 빠른 점검</h3>
        <p>v${escapeHtml087(params.version)} 기준으로 UI 안전 영역, 세이브, 에셋, 콘텐츠 연결 그래프를 함께 점검합니다.</p>
      </div>
